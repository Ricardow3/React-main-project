    ...
    return (
        <div>
            <section className="body-texto">
                ...
                <p>
                    O primeiro trajeto vai do Polo Norte até a linha do equador, percorrendo um ângulo de 90°, equivalente a <span ref={eq1}></span> da circunferência da esfera.
                </p>
                <p>
                    O segundo trajeto percorre ao longo da linha do equador um ângulo de 45°, equivalente a <span ref={eq2}></span> da circunferência.
                </p>
                <p>
                ...
                <p>
                    Onde <span style={{fontSize: 20}} ref={eq6}></span> é o ângulo percorrido.
                </p>
                <p>
